...
func (x *Bootstrap) GetWhiteList() []string {
	if x != nil {
		return x.WhiteList
	}
	return nil
...
const file_internal_conf_conf_proto_rawDesc = "" +
	...
	"kratos.api\x1a\x1egoogle/protobuf/duration.proto\"\x9f\x01\n" +
	"\tBootstrap\x12*\n" +
	"\x06server\x18\x01 \x01(\v2\x12.kratos.api.ServerR\x06server\x12$\n" +
	"\x04data\x18\x02 \x01(\v2\x10.kratos.api.DataR\x04data\x12!\n" +
	"\x03jwt\x18\x03 \x01(\v2\x0f.kratos.api.JwtR\x03jwt\x12\x1d\n" +
	"\n" +
	"white_list\x18\x04 \x03(\tR\twhiteList\"\xb8\x02\n" +
	"\x06Server\x12+\n" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\"7\n" +
	"\x03Jwt\x12\x16\n" +
	"\x06secret\x18\x01 \x01(\tR\x06secret\x12\x18\n" +
	"\aexpires\x18\x02 \x01(\x03R\aexpiresB7Z5github.com/go-kratos/kratos-layout/internal/conf;confb\x06proto3"
